public class Linkedlist {
    ...
    public String fetchData(String editor) {
        ...
        if (isFound != null) {
            return "The editor" + isFound.getData().getName() + " is founded with edited article as much as"
                    + isFound.getData().getFreq() + "articles.";
        } else {
            return "The editor " + editor + " is not founded.";
        }
    }
    ...
    public void menubaru(String editor) {
        ...
        if (isFound != null) {
            System.out.println("The editor " + isFound.getData().getName() + " edited " + isFound.getData().getFreq()
                    + " articles.");
            isFound.getData().getTitle();

        } else {
            System.out.println("Data of " + editor + " is not founded.");
        }
    }
    ...
    public void searchContainsEditor(String editor) {
        ...
        while (current != null) {
            if (current.getData().getName().toLowerCase().contains(editor.toLowerCase())) {
                System.out.println("The editor " + current.getData().getName() + " is founded with "
                        + current.getData().getFreq() + " articles.");
            }
            if (current.getNext() == null) {
                break;
            }
